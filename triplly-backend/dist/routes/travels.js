...
travels.patch('/:travelId', requireTravelAccess('editor'), zValidator('json', updateTravelSchema), async (c) => {
    ...
    if (data.startDate !== undefined)
        travel.startDate = data.startDate ? new Date(data.startDate) : null;
    if (data.endDate !== undefined)
        travel.endDate = data.endDate ? new Date(data.endDate) : null;
    if (data.coverImageUrl !== undefined)
        travel.coverImageUrl = data.coverImageUrl;
